        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('cds.create') }}" class="btn btn-md btn-success mb-3">ADD CDs</a>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @forelse ($CDs as $CD)
                                    <tr>
                                    <td>{{ $CD->{'Judul CD dan DVD'} }}</td>
                                    <td>{{ $CD->Author }}</td>
                                    <td>{{ $CD->{'Tahun Terbit'} }}</td>
                                   <td>{{ $CD->{'Access_Granted'} }}</td>
