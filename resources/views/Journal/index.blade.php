        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('Journals.create') }}" class="btn btn-md btn-success mb-3">ADD Journals</a>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @forelse ($Journals as $Journal)
                                    <tr>
                                    <td>{{ $Journal->{'Judul Journal'} }}</td>
                                    <td>{{ $Journal->Author }}</td>
                                    <td>{{ $Journal->{'Tahun Terbit'} }}</td>
                                   <td>{{ $Journal->{'Access_Granted'} }}</td>
